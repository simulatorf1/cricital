    ...
    iniciarContadorSimulacion() {
        ...
        const iniciarAnimacion = () => {
            ...
            const puntosCircuito = [
                {x: 500, y: 180, t: 0.000},
                {x: 340, y: 180, t: 0.021},
                {x: 330.8, y: 173, t: 0.042},
                {x: 330.8, y: 163.8, t: 0.063},
                {x: 328.8, y: 143.8, t: 0.083},
                {x: 309.472, y: 139.406, t: 0.104},
                {x: 294.032, y: 161.55, t: 0.125},
                {x: 292.966, y: 180, t: 0.146},
                {x: 290.304, y: 197.568, t: 0.167},
                {x: 278.592, y: 194.906, t: 0.188},
                {x: 265.282, y: 185.856, t: 0.208},
                {x: 248.778, y: 186.92, t: 0.229},
                {x: 242.388, y: 217.266, t: 0.250},
                {x: 241.856, y: 258.262, t: 0.271},
                {x: 221.87, y: 292.054, t: 0.292},
                {x: 199.748, y: 322.472, t: 0.313},
                {x: 203.894, y: 346.67, t: 0.333},
                {x: 221.178, y: 359.114, t: 0.354},
                {x: 239.844, y: 348.744, t: 0.375},
                {x: 268.882, y: 330.768, t: 0.396},
                {x: 285.474, y: 323.854, t: 0.417},
                {x: 315.202, y: 331.46, t: 0.438},
                {x: 332.484, y: 353.582, t: 0.458},
                {x: 350.46, y: 377.088, t: 0.479},
                {x: 380, y: 380, t: 0.500},
                {x: 403.692, y: 365.336, t: 0.521},
                {x: 413.372, y: 339.064, t: 0.542},
                {x: 398.852, y: 311.41, t: 0.563},
                {x: 369.816, y: 283.066, t: 0.583},
                {x: 362.904, y: 265.09, t: 0.604},
                {x: 386.408, y: 263.016, t: 0.625},
                {x: 411.298, y: 256.794, t: 0.646},
                {x: 436.876, y: 254.03, t: 0.667},
                {x: 453.47, y: 283.066, t: 0.688},
                {x: 466.604, y: 324.546, t: 0.708},
                {x: 483.888, y: 359.114, t: 0.729},
                {x: 512.924, y: 348.744, t: 0.750},
                {x: 520.53, y: 328.694, t: 0.771},
                {x: 517.072, y: 312.102, t: 0.792},
                {x: 540, y: 300, t: 0.813},
                {x: 563.392, y: 303.114, t: 0.833},
                {x: 568.232, y: 285.14, t: 0.854},
                {x: 569.614, y: 244.35, t: 0.875},
                {x: 573.072, y: 203.562, t: 0.896},
                {x: 577.22, y: 152.402, t: 0.917},
                {x: 546.108, y: 148.946, t: 0.938},
                {x: 532.974, y: 180, t: 0.958},
                {x: 519.146, y: 198.03, t: 0.979},
                {x: 500, y: 180, t: 1.000}
            ];
            ...
            this.timerInterval = setInterval(() => {
                ...
                if (tiempoTranscurridoReal < calentamientoDuration) {
                    ...
                    // Coche en meta
                    coche.setAttribute('x', 500);
                    coche.setAttribute('y', 180);
                    coche.setAttribute('fill', '#4CAF50');
        ...
        return `
            <div class="control-activo">
                ...
                <div class="circuito-container">
                    <svg id="circuito-svg" width="100%" height="400" viewBox="0 0 1000 400" preserveAspectRatio="xMidYMid meet">
                        <defs>
