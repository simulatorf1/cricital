...
class F1Manager {
    constructor(user, escuderia, supabase) {
        ...
        // Sistema de puntos "dientes de sierra" - TODOS TECHO 100, PERO EN DIFERENTES POSICIONES
        this.puntosDientesSierra = {
            // SUELO: Techo 100 en la pieza 49, luego bajada
            'suelo': [3, 8, 0, 11, 5, 15, 8, 19, 0, 24, 12, 28, 15, 32, 0, 36, 23, 40, 0, 45,
                      28, 49, 0, 54, 34, 58, 0, 63, 38, 67, 0, 72, 43, 76, 0, 81, 46, 85, 0, 90,
                      49, 94, 0, 98, 54, 100, 0, 95, 58, 92],
        
            // MOTOR: Techo 100 en la pieza 46, luego mantenimiento
            'motor': [3, 8, 11, 12, 5, 15, 0, 20, 10, 23, 0, 28, 15, 30, 34, 35, 20, 38, 39, 43,
                      25, 45, 0, 0, 1, 52, 0, 57, 30, 60, 0, 65, 32, 68, 40, 73, 35, 75, 36, 80,
                      38, 82, 50, 87, 40, 100, 91, 98, 42, 99],
        
            // ALERÓN DELANTERO: Techo 100 en la pieza 47, luego caída
            'aleron_delantero': [2, 6, 19, 9, 3, 14, 0, 17, 5, 22, 20, 25, 8, 30, 0, 33, 9, 37, 31, 41,
                                 12, 45, 56, 48, 16, 53, 0, 56, 19, 61, 61, 64, 22, 69, 0, 72, 25, 76, 75, 80,
                                 28, 84, 47, 88, 31, 92, 100, 95, 34, 90],
        
            // CAJA CAMBIOS: Techo 100 en la pieza 43, meseta
            'caja_cambios': [3, 8, 13, 12, 5, 16, 0, 20, 8, 24, 13, 28, 11, 32, 26, 36, 13, 40, 52, 44,
                             16, 48, 13, 52, 18, 56, 65, 60, 21, 64, 65, 68, 23, 72, 78, 76, 26, 80, 91, 84,
                             29, 88, 100, 92, 31, 96, 95, 94, 34, 98],
        
            // PONTONES: Techo 100 en la pieza 41, luego estabilización
            'pontones': [2, 5, 0, 8, 3, 11, 15, 14, 5, 17, 0, 20, 6, 23, 31, 26, 8, 29, 8, 32,
                         9, 35, 0, 38, 11, 41, 31, 44, 12, 47, 15, 50, 14, 53, 0, 56, 15, 59, 62, 62,
                         17, 100, 70, 68, 19, 71, 80, 75, 20, 82],
        
            // SUSPENSIÓN: Techo 100 en la pieza 48, luego bajada
            'suspension': [3, 6, 0, 9, 5, 12, 0, 15, 6, 18, 0, 21, 8, 24, 0, 27, 9, 30, 0, 33,
                           11, 36, 0, 39, 12, 42, 0, 45, 14, 48, 0, 51, 15, 54, 0, 57, 17, 60, 0, 63,
                           18, 66, 0, 69, 20, 72, 0, 75, 100, 88],
        
            // ALERÓN TRASERO: Techo 100 en la pieza 44, pico temprano
            'aleron_trasero': [0, 8, 8, 11, 3, 15, 8, 18, 6, 23, 9, 26, 9, 31, 11, 34, 12, 39, 14, 42,
                               15, 46, 46, 49, 18, 54, 54, 57, 22, 62, 0, 65, 25, 69, 69, 72, 28, 77, 0, 80,
                               31, 85, 0, 88, 100, 92, 0, 95, 37, 98],
        
            // CHASIS: Techo 100 en la pieza 50 (final)
            'chasis': [3, 9, 0, 12, 5, 17, 0, 20, 8, 25, 0, 28, 11, 33, 0, 36, 14, 41, 0, 44,
                       17, 49, 0, 52, 20, 57, 0, 60, 23, 65, 0, 68, 26, 73, 0, 76, 29, 81, 0, 84,
                       32, 89, 0, 92, 35, 97, 0, 99, 38, 100],
        
            // FRENOS: Techo 100 en la pieza 35, luego caída y repunte
            'frenos': [2, 5, 8, 8, 3, 11, 8, 14, 5, 17, 31, 20, 6, 23, 31, 26, 8, 29, 31, 32,
                       9, 35, 0, 38, 11, 41, 0, 0, 12, 47, 0, 50, 14, 0, 0, 0, 15, 60, 0, 63,
                       17, 66, 100, 69, 18, 72, 77, 75, 20, 80],
        
            // VOLANTE: Techo 100 en la pieza 16 (MUY TEMPRANO), luego errático
            'volante': [0, 7, 4, 4, 11, 18, 4, 25, 7, 0, 14, 29, 0, 36, 11, 100, 18, 40, 0, 47,
                        14, 0, 21, 50, 72, 58, 18, 0, 25, 61, 0, 68, 21, 0, 29, 72, 100, 79, 25, 0,
                        32, 83, 0, 90, 29, 0, 36, 94, 0, 98],
        
            // ELECTRÓNICA: Techo 100 en la pieza 31, luego mantenimiento
            'electronica': [0, 0, 0, 14, 0, 20, 11, 0, 14, 26, 14, 32, 17, 52, 20, 37, 0, 43, 23, 0,
                            26, 49, 0, 55, 29, 29, 32, 61, 0, 67, 100, 0, 37, 73, 43, 79, 40, 0,
                            43, 85, 58, 91, 46, 0, 49, 97, 0, 100, 52, 60]
        };
