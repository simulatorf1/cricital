        ...
        return `
            <div class="almacen-botones-container">
                ...
                <div class="areas-grid-botones" id="areas-grid-botones">
                    <!-- Las áreas con botones se cargarán aquí -->
                </div>
                ...
                if (piezasArea.length > 0) {
                    ...
                    html += `
                        <div class="fila-area-almacen">
                            ...
                            <div class="piezas-fila-almacen" style="display: flex; flex-direction: row; flex-wrap: nowrap; overflow-x: auto; gap: 15px; padding: 15px;">
                    `;
